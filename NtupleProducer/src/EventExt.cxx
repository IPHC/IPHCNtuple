...
//   metUncorrectedSumEt   = -1000;
   ...
   is_2lSS1tau_SR_Data_ttH = 0;
   is_2lSS1tau_SR_Data_tHq = 0;
   is_2lSS1tau_SR        = 0;
   is_2lSS1tau_SR_ttH    = 0;
   is_2lSS1tau_SR_tHq    = 0;
   is_2lSS1tau_Fake      = 0;
   is_2lSS1tau_Fake_ttH  = 0;
   is_2lSS1tau_Fake_tHq  = 0;
   is_2lSS1tau_Flip_Data = 0;
   is_2lSS1tau_Flip_Data_ttH = 0;
   is_2lSS1tau_Flip_Data_tHq = 0;
   is_2lSS1tau_Flip      = 0;
   is_2lSS1tau_Flip_ttH  = 0;
   is_2lSS1tau_Flip_tHq  = 0;
   is_2lOS1tau           = 0;

...
class Electron : public Base
{
    public:
        ...
        //Default CB IDs in AOD
		bool isVeto_tZq()					 {return _isVeto_tZq;};
		bool isLoose_tZq()					 {return _isLoose_tZq;};
		bool isMedium_tZq()					 {return _isMedium_tZq;};
        bool isTight_tZq()					 {return _isTight_tZq;};
        //Home-made CB IDs (can vary iso, ...)
        bool isVeto_CBID_tZq()				 {return _isVeto_CBID_tZq;};
        bool isLoose_CBID_tZq()				 {return _isLoose_CBID_tZq;};
        bool isMedium_CBID_tZq()			 {return _isMedium_CBID_tZq;};
        bool isTight_CBID_tZq()				 {return _isTight_CBID_tZq;};
        ...
        bool pass_scleta()						{return _pass_scleta;};
        bool pass_tight_iso_tZq()			    {return _pass_tight_iso_tZq;};
    ...
    protected:
        ...
        bool    _isMedium_tZq;
        bool    _isTight_tZq;
        bool    _isVeto_CBID_tZq;
        bool    _isLoose_CBID_tZq;
        bool    _isMedium_CBID_tZq;
        bool    _isTight_CBID_tZq;
